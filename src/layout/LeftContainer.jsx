  ...
  return (
    ...
    <div className='flex absolute -translate-y-full -left[1px]'>
        {tabsList.map((tab, index) => (
            ...
            key={index}
            className='min-w-[125px] py-2 px3 mr-4 font-bold border-t border-x border-gray-300 bg-slate-50 hover:bg-slate-200 text-slate-700 rounded-t focus:outline-none focus:ring-2 ring-inset focus: ring-blue-300'> 
            {tab.name}
